...
if __name__ == '__main__':
    ...
    p1 = the_connection.recv_match(type='LOCAL_POSITION_NED', blocking=True)
    the_connection.mav.send(mavutil.mavlink.MAVLink_set_position_target_local_ned_message(10,
    the_connection.target_system,
    the_connection.target_component,
    mavutil.mavlink.MAV_FRAME_LOCAL_NED,
    int(0b010111111000), x, 0, p1.z, 0, 0, 0, 0, 0, 0, 0, 0))
    ...
    p2 = the_connection.recv_match(type='LOCAL_POSITION_NED', blocking=True)
    the_connection.mav.send(mavutil.mavlink.MAVLink_set_position_target_local_ned_message(10,
    the_connection.target_system,
    the_connection.target_component,
    mavutil.mavlink.MAV_FRAME_LOCAL_NED,
    int(0b010111111000), p2.x, -y, p2.z, 0, 0, 0, 0, 0, 0, 0, 0))
